...
const MyProfile = () => {
	 ...
	 * Updates profileData state as user types
	 */
	 ...
	 * Resets profileData to original values
	 */
	const handleCancel = () => {
		setIsEditing(false)
				...
				<div className="card-body">
					...
					<div className="flex flex-col items-center mb-6 pb-6 border-b border-base-300">
						<div className="relative">
							...
							{/* Camera button for photo upload (only in edit mode) */}
							{isEditing && (
								<button 
					...
					<div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
						...
						<div className="form-control">
							...
							<input
								...
								disabled={!isEditing}
								className={`input input-bordered ${!isEditing ? 'bg-base-200' : 'bg-base-100'}`}
						...
						<div className="form-control lg:col-span-2">
							...
							<textarea
								...
								disabled={!isEditing}
								rows="4"
								className={`textarea textarea-bordered ${!isEditing ? 'bg-base-200' : 'bg-base-100'}`}
